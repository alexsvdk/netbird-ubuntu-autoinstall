...
export APT_REGION APT_MIRROR APT_SECURITY_MIRROR APT_FALLBACK NETWORK_INTERFACE SWAP_SIZE_GIB NOTIFY_TOPIC MIHOMO_IMAGE OFFLINE_BUNDLE_REFRESH OFFLINE_BUNDLE_CACHE OFFLINE_ARTIFACT_REFRESH OFFLINE_ARTIFACT_CACHE
